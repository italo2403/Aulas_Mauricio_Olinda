...
<nav>
  <a href="" class="nome">Home</a>
  <a href="login.html" class="nome">Login</a>
  <a href="" class="nome">Contato</a>
</nav>
  ...
  <p>Total de Vendas: <span id="totalVendas" name="totalVendas"><?php echo $totalVendas; ?></span></p><br>
  <input type="submit"  id="btnsub" value="Cadastrar">
  
  </form>

<button onclick="window.print()" id="btnimpr">Imprimir</button> 
